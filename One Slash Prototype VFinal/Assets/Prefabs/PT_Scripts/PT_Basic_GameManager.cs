...
public class PT_Basic_GameManager : MonoBehaviour {
    ...
    public Monster_Spawner_Builder MonsterManager;
    public string[] levelsData;

    public string[] MonsterLevelsData;
    ...
    void Start () {
        ...
        MonsterManager.rawMapData = MonsterLevelsData[currentLevelIndex];
        MonsterManager.ReloadMap();
